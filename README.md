...
The neural regression baseline is also published as the `nn_regression` plugin in [agentic-ml-pipeline](https://github.com/milos-plavsic/agentic-ml-pipeline).
